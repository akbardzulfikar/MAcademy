...
import co.id.macademy.utils.LiveDataTestUtil
...
class AcademyRepositoryTest {
    ...
    fun getAllCourses() {
        ...
        com.nhaarman.mockitokotlin2.verify(remote).getAllCourses(any())
    ...
    fun getAllModulesByCourse() {
        ...
        com.nhaarman.mockitokotlin2.verify(remote).getModules(eq(courseId), any())
        assertNotNull(courseEntities)
